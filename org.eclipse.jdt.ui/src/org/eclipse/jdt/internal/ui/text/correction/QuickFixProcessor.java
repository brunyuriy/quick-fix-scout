...
public class QuickFixProcessor implements IQuickFixProcessor {
	...
	private void process(IInvocationContext context, IProblemLocation problem, Collection<ICommandAccess> proposals) throws CoreException {
		...
		String pName = context.getASTRoot().getJavaElement().getJavaProject().getProject().getName();
		boolean specCall = pName.contains("DO_NOT_DELETE");
		long micros = (end-start) / (long) 1000;
	...
	private String padZero(long value, int limit)
	{
	    String result = value + "";
