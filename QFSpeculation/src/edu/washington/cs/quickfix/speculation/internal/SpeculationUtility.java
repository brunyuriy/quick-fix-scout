...
{
    private static ReentrantLock copyProjectCounterLock_ = new ReentrantLock();
    private static int copyProjectCounter_ = 0;
    // Logger.
    ...
    {
        int result;
        copyProjectCounterLock_.lock();
        result = copyProjectCounter_;
        copyProjectCounter_++;
        copyProjectCounterLock_.unlock();
        return result;
    }
