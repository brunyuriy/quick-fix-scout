        ...
        ICompletionProposalExtension2, ICompletionProposalExtension3
{
    ...
    private void openErrorDialog(Shell shell, Exception e)
    {
        MessageDialog.openError(shell,
                JFaceTextTemplateMessages.getString("TemplateProposal.errorDialog.title"), e.getMessage()); //$NON-NLS-1$
    }
    ...
    /*
     * @see
     * org.eclipse.jface.text.contentassist.ICompletionProposalExtension3#getPrefixCompletionStart(org.eclipse.jface
     * .text.IDocument, int)
     */
