...
/**
 * A collection of templates. Clients may instantiate this class. In order to load templates contributed using the
 * <code>org.eclipse.ui.editors.templates</code> extension point, use a <code>ContributionTemplateStore</code>.
 * 
 * @since 3.0
 */
public class TemplateStore
{
    ...
    /**
     * The key into <code>fPreferenceStore</code> the value of which holds custom templates encoded as XML.
     */
    private String fKey;
    /**
     * The context type registry, or <code>null</code> if all templates regardless of context type should be loaded.
     */
    private ContextTypeRegistry fRegistry;
    /**
     * Set to <code>true</code> if property change events should be ignored (e.g. during writing to the preference
     * store).
     * 
     * @since 3.2
     */
    ...
    /**
     * Starts listening for property changes on the preference store. If the configured preference key changes, the
     * template store is {@link #load() reloaded}. Call {@link #stopListeningForPreferenceChanges()} to remove any
     * listener and stop the auto-updating behavior.
     * 
     * @since 3.2
     */
    public final void startListeningForPreferenceChanges()
    {
        if (fPropertyListener == null)
        {
            fPropertyListener = new IPropertyChangeListener()
            {
                ...
                {
                    /*
                     * Don't load if we are in the process of saving ourselves. We are in sync anyway after the save
                     * operation, and clients may trigger reloading by listening to preference store updates.
                     */
    ...
    /**
     * Stops the auto-updating behavior started by calling {@link #startListeningForPreferenceChanges()}.
     * 
     * @since 3.2
     */
    ...
    /**
     * Handles an {@link IOException} thrown during reloading the preferences due to a preference store update. The
    ...
    /**
     * Hook method to load contributed templates. Contributed templates are superseded by customized versions of user
     * added templates stored in the preferences.
     * <p>
     ...
     * 
     * @param contextTypeId the id of the context type of the requested templates, or <code>null</code> if all templates
     *            should be returned
     ...
     * @return the first enabled template that matches both name and context type id, or <code>null</code> if none is
     *         found
     */
     ...
     * 
     * @param name the name of the template searched for
     * @param contextTypeId the context type id to clip unwanted templates, or <code>null</code> if any context type is
     *            OK
     * @return the first enabled template that matches both name and context type id, or <code>null</code> if none is
     *         found
     */
    ...
    /**
     * Returns the template data of the template with id <code>id</code> or <code>null</code> if no such template can be
     * found.
     * 
     ...
     * @return <code>true</code> if the context type specified by the id is present in the context type registry, or if
     *         no registry is specified
     */
