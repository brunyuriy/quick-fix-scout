...
/**
 * TemplatePersistenceData stores information about a template. It uniquely references contributed templates via their
 * id. Contributed templates may be deleted or modified. All template may be enabled or not.
 * <p>
 * Clients may use this class, although this is not usually needed except when implementing a custom template preference
 * page or template store. This class is not intended to be subclassed.
 * </p>
 * 
 * @since 3.0
...
public class TemplatePersistenceData
{
    ...
    /**
     * Creates a new instance. If <code>id</code> is not <code>null</code>, the instance is represents a template that
     * is contributed and can be identified via its id.
     * 
     * @param template the template which is stored by the new instance
     * @param enabled whether the template is enabled
     * @param id the id of the template, or <code>null</code> if a user-added instance should be created
     */
    ...
    /**
     * Returns whether the receiver represents a custom template, i.e. is either a user-added template or a contributed
     * template that has been modified.
     * 
     * @return <code>true</code> if the contained template is a custom template and cannot be reconstructed from the
     *         contributed templates
     */
    public boolean isCustom()
    {
        return fId == null || fIsDeleted || fOriginalIsEnabled != fCustomIsEnabled
    ...
    /**
     * Returns <code>true</code> if the contained template was added by a user, i.e. does not reference a contributed
     * template.
     * 
