 ...
 * <ul>
 * <li>{@link IHyperlinkPresenterExtension} since version 3.4, adds the ability to query whether the currently shown
 * hyperlinks can be hidden.</li>
 * </ul>
 * </p>
 * <p>
...
public interface IHyperlinkPresenter
{
     ...
     *             <li>{@link #canShowMultipleHyperlinks()} returns <code>false</code> and <code>hyperlinks</code>
     *             contains more than one element</li>
     *             </ul>
     */
     ...
     * {@link #showHyperlinks(IHyperlink[])}.
     */
    void hideHyperlinks();
