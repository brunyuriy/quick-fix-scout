 ...
 * <p>
 * It can only be used together with the {@link HyperlinkManager#FIRST} or the
 * {@link HyperlinkManager#LONGEST_REGION_FIRST} hyperlink strategy.
 * </p>
 * 
 * @since 3.1
 */
public class DefaultHyperlinkPresenter implements IHyperlinkPresenter, IHyperlinkPresenterExtension,
        ITextPresentationListener, ITextInputListener, IDocumentListener, IPropertyChangeListener
{
     ...
     * 
     * @param color the hyperlink color or <code>null</code> if the existing text color should be preserved; to be
     ...
     * Creates a new default hyperlink presenter.
     * 
     * @param color the hyperlink color or <code>null</code> if the existing text color should be preserved
     */
    ...
    /*
     * @see
     * org.eclipse.jdt.internal.ui.javaeditor.IHyperlinkControl#activate(org.eclipse.jdt.internal.ui.javaeditor.IHyperlink
     * [])
     */
     ...
     * 
     * @param color the hyperlink foreground color or <code>null</code> if the existing text color should be preserved
     */
