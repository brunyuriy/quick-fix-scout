...
/**
 * A hyperlink detector that can provide adapters through a context that can be set by the creator of this hyperlink
 * detector.
 * <p>
...
public abstract class AbstractHyperlinkDetector implements IHyperlinkDetector, IHyperlinkDetectorExtension
{
    ...
    /**
     * Returns an object which is an instance of the given class and provides additional context for this hyperlink
     * detector.
     * 
     * @param adapterClass the adapter class to look up
     * @return an instance that can be cast to the given class, or <code>null</code> if this object does not have an
