/*******************************************************************************
 * Copyright (c) 2008, 2010 IBM Corporation and others. All rights reserved. This program and the accompanying materials
...
public class MultipleHyperlinkPresenter extends DefaultHyperlinkPresenter
{
     ...
     */
    private static class LinkListInformationControl extends AbstractInformationControl implements
            ...
            IWidgetTokenKeeper, IWidgetTokenKeeperExtension
    {
        private class Closer implements IInformationControlCloser, Listener, KeyListener, MouseListener
        {
            ...
            /*
             * @see
             * org.eclipse.jface.text.AbstractInformationControlManager.IInformationControlCloser#setInformationControl
            ...
            /*
             * @see
             * org.eclipse.jface.text.AbstractInformationControlManager.IInformationControlCloser#setSubjectControl(
            ...
            /*
             * @see
             * org.eclipse.jface.text.AbstractInformationControlManager.IInformationControlCloser#start(org.eclipse.
            ...
            /**
             * Tests whether a given mouse location is within the keep-up zone. The hover should not be hidden as long
             * as the mouse stays inside this zone.
             * 
            ...
            private boolean inKeepUpZone(int x, int y, Rectangle controlBounds)
            {
                ...
                Rectangle alsoKeepUp = new Rectangle(fSubjectArea.x, keepUpY, fSubjectArea.width, totalBounds.y
                        - keepUpY);
        ...
        /**
         * Priority of the hover managed by this manager. Default value: One higher then for the hovers managed by
        ...
        /**
         * Create a new MultipleHyperlinkHoverManager. The MHHM can show and hide the given MultipleHyperlinkHover
         * inside the given ITextViewer.
         * 
        ...
        public MultipleHyperlinkHoverManager(MultipleHyperlinkHover hover, ITextViewer viewer,
                MultipleHyperlinkPresenter hyperlinkPresenter)
        {
        ...
        /*
         * @see
         * org.eclipse.jface.text.AbstractInformationControlManager#computeInformationControlLocation(org.eclipse.swt
         * .graphics.Rectangle, org.eclipse.swt.graphics.Point)
         */
        ...
        /*
         * @see
         * org.eclipse.jface.text.AbstractInformationControlManager#showInformationControl(org.eclipse.swt.graphics.
         * Rectangle)
         */
        ...
        /**
         * Returns <code>true</code> if the information control managed by this manager is visible, <code>false</code>
         * otherwise.
         * 
    ...
    /**
     * Creates a new multiple hyperlink presenter which uses {@link #HYPERLINK_COLOR} to read the color from the given
     * preference store.
     * 
    ...
    private void setCaret()
    {
        ...
        if (fCursorOffset != -1
                && !(fSubjectRegion.getOffset() <= selectedRange.x && selectedRange.x + selectedRange.y <= fSubjectRegion
                        .getOffset() + fSubjectRegion.getLength()))
