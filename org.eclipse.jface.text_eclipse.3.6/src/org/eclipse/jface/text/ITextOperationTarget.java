...
/**
 * Defines the target for text operations. <code>canDoOperation</code> informs the clients about the ability of the
 * target to perform the specified operation at the current point in time. <code>doOperation</code> executes the
 * specified operation.
 * <p>
 * In order to provide backward compatibility for clients of <code>ITextOperationTarget</code>, extension interfaces are
 * used as a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link org.eclipse.jface.text.ITextOperationTargetExtension} since version 2.0 introducing text operation
...
public interface ITextOperationTarget
{
    ...
    /**
     * Text operation code for deleting the selected text or if selection is empty the character at the right of the
     * current position.
     */
    ...
    /**
     * Performs the operation specified by the operation code on the target. <code>doOperation</code> must only be
     * called if <code>canDoOperation</code> returns <code>true</code>.
     * 
     * @param operation the operation code
     */
