...
/**
 * Formatting strategy for context based content formatting. Retrieves the preferences set on the formatting context's
 * {@link FormattingContextProperties#CONTEXT_PREFERENCES} property and makes them available to subclasses.
 * <p>
 * 
 * @since 3.0
 */
public abstract class ContextBasedFormattingStrategy implements IFormattingStrategy, IFormattingStrategyExtension
{
    ...
    /*
     * @see org.eclipse.jface.text.formatter.IFormattingStrategy#format(java.lang.String, boolean, java.lang.String,
     * int[])
     */
    ...
    /*
     * @see
     * org.eclipse.jface.text.formatter.IFormattingStrategyExtension#formatterStarts(org.eclipse.jface.text.formatter
     * .IFormattingContext)
     */
