 ...
 * <p>
 * Updates formatting strategies to be able to receive a more general <code>IFormattingContext</code> object from its
 * associated content formatters.
 * <p>
 ...
 * </ul>
 * <p>
 * Note that multiple calls to <code>formatterStarts</code> can be issued to a strategy before launching the formatting
 * process with <code>format</code>.
 * <p>
