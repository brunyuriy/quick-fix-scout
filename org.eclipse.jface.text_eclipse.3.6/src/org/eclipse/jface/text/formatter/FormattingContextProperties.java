...
/**
 * Keys used by <code>IFormattingContext</code> objects to register specific properties needed during the formatting
 * process of a content formatter implementing <code>IContentFormatterExtension</code>.
 * 
...
{
    /**
     * Property key of the document property. The property must implement <code>java.lang#Boolean</code>. If set to
     * <code>true</code> the whole document is formatted.
     * <p>
     ...
     * <code>org.eclipse.jface.text#TypedPosition</code>. The partition a context based formatting strategy should
     * format.
     * <p>
    ...
    /**
     * Property key of the preferences property. The property must implement <code>java.util#Map</code>. The formatting
     * preferences mapping preference keys to values.
     * <p>
    ...
    /**
     * Property key of the region property. The property must implement <code>org.eclipse.jface.text#IRegion</code>. The
     * region to format. If set, {@link FormattingContextProperties#CONTEXT_DOCUMENT} should be <code>false</code> for
     * this to take effect.
     * <p>
