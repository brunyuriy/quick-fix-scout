...
/**
 * Formatting context used in formatting strategies implementing interface <code>IFormattingStrategyExtension</code>.
 * 
...
public interface IFormattingContext
{
     ...
     * <p>
     * Note that the preference keys returned by {@link #getPreferenceKeys()} must not be used in the preference store.
     ...
     * @param property Property to store in the context. If already present, the new property overwrites the present
     *            one.
     */
     ...
     * <p>
     * Note that the preference keys returned by {@link #getPreferenceKeys()} must not be used in the map. Otherwise the
     ...
     * @param useDefault <code>true</code> if the default preferences should be used, <code>false</code> otherwise
     */
