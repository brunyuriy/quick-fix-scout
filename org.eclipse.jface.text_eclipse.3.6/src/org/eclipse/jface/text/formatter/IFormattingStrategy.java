...
/**
 * A formatting strategy is assumed to be specialized on formatting text of a particular content type. Each formatting
 * process calls the strategy's methods in the following sequence:
 * <ul>
 ...
 * </ul>
 * <p>
 * This interface must be implemented by clients. Implementers should be registered with a content formatter in order
 * get involved in the formatting process.
 * </p>
 */
public interface IFormattingStrategy
{
     ...
     * 
     * @param initialIndentation the indent string of the first line at which the overall formatting process starts.
     */
    void formatterStarts(String initialIndentation);

    /**
     * Formats the given string. During the formatting process this strategy must update the given character positions
     * according to the changes applied to the given string.
     * 
