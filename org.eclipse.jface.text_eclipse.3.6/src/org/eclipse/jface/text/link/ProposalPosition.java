...
public class ProposalPosition extends LinkedPosition
{
    ...
    public boolean equals(Object o)
    {
        ...
        {
            if (super.equals(o)) { return Arrays.equals(fProposals, ((ProposalPosition) o).fProposals); }
        }
        return false;
    }

    /**
     * Returns the proposals attached to this position. The returned array is owned by this
     * <code>ProposalPosition</code> and may not be modified by clients.
     * 
