...
final class LinkedPositionAnnotations extends AnnotationModel
{
    ...
    /**
     * Sets the position that should be highlighted as the focus position, i.e. as the position whose changes are
     * propagated to all its linked positions by the linked environment.
     * 
    ...
    /**
     * Sets the position that should be highlighted as the exit position, i.e. as the position whose changes are
     * propagated to all its linked positions by the linked environment.
     * 
    ...
    /**
     * Sets the positions that should be highlighted as the slave positions, i.e. as the positions that are linked to
     * the focus position.
     * 
    ...
    /**
     * Sets the positions that should be highlighted as the target positions, i.e. as the positions that can be jumped
     * to in a linked set up.
     * 
    ...
    /**
     * Switches the focus position to <code>position</code> given the <code>LinkedModeModel env</code>. The slave
     * positions for <code>position</code> is extracted from the environment and set accordingly, the target positions
     * are updated as well.
     * 
    ...
    /**
     * Prune <code>list</code> of all <code>LinkedPosition</code>s that do not belong to this model's
     * <code>IDocument</code>.
     * 
    ...
    /*
     * @see org.eclipse.jface.text.source.AnnotationModel#addPosition(org.eclipse.jface.text.IDocument,
    ...
    /*
     * @see org.eclipse.jface.text.source.AnnotationModel#removePosition(org.eclipse.jface.text.IDocument,
     * org.eclipse.jface.text.Position)
     */
