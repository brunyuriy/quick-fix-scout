...
/**
 * Extension interface for {@link org.eclipse.jface.text.ITextViewer}. Adds the ability to print and set how hovers
 * should be enriched when the mouse is moved into them.
 * 
 * @since 3.4
 */
public interface ITextViewerExtension8
{
    ...
    /**
     * Sets the hover enrich mode. A non-<code>null</code> <code>mode</code> defines when hovers should be enriched once
     * the mouse is moved into them. If <code>mode</code> is <code>null</code>, hovers are automatically closed when the
     * mouse is moved out of the {@link ITextHover#getHoverRegion(ITextViewer, int) hover region}.
     * <p>
     * Note that a hover can only be enriched if its
     * {@link IInformationControlExtension5#getInformationPresenterControlCreator()} is not <code>null</code>.
     * </p>
     * 
