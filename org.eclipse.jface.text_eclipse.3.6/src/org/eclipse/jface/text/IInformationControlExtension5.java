...
public interface IInformationControlExtension5
{
     ...
     * when the mouse is moved into this control and it needs to be
     * {@link ITextViewerExtension8#setHoverEnrichMode(org.eclipse.jface.text.ITextViewerExtension8.EnrichMode)
     * enriched} or when it needs to be made sticky for other reasons.
     * </p>
     * <p>
