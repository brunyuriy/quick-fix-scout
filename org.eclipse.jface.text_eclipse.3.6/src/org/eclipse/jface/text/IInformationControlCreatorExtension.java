...
/**
 * Extension interface for {@link org.eclipse.jface.text.IInformationControlCreator}
 * <p>
 * Introduces tests whether information controls can be reused and whether information control creators can replace each
 * other.
 * 
...
public interface IInformationControlCreatorExtension
{
    ...
    /**
     * Tests whether this information control creator can replace the given information control creator. This is the
     * case if the two creators create the same kind of information controls.
     * 
     * @param creator the creator to be checked
     * @return <code>true</code> if the given creator can be replaced, <code>false</code> otherwise
     */
