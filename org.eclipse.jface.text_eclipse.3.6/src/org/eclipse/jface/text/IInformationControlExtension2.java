 ...
 * <p>
 * Replaces the concept of textual information to be displayed with the more general concept of an input of the
 * information control. Text to be displayed set with <code>setInformation(String)</code> is ignored.
 * 
...
{
    /**
     * Sets the input to be presented in this information control. The concrete contract the input object is expected to
     * adhere is defined by the implementer of this interface.
     * 
