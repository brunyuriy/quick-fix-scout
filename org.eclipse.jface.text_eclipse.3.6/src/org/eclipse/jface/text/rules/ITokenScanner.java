...
/**
 * A token scanner scans a range of a document and reports about the token it finds. A scanner has state. When asked,
 * the scanner returns the offset and the length of the last found token.
 * 
