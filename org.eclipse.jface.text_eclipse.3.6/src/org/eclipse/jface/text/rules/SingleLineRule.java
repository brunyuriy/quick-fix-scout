...
/**
 * A specific configuration of pattern rule whereby the pattern begins with a specific sequence and may end with a
 * specific sequence, but will not span more than a single line.
 */
public class SingleLineRule extends PatternRule
{
    ...
    /**
     * Creates a rule for the given starting and ending sequence which, if detected, will return the specified token.
     * Alternatively, the line can also be ended with the end of the file. Any character which follows the given escape
     ...
     * Creates a rule for the given starting and ending sequence which, if detected, will return the specified token.
     * Alternatively, the line can also be ended with the end of the file. Any character which follows the given escape
     * character will be ignored. In addition, an escape character immediately before an end of line can be set to
     * continue the line.
     * 
     * @param startSequence the pattern's start sequence
     * @param endSequence the pattern's end sequence
