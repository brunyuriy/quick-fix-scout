 ...
 * Anton Leherbauer (Wind River Systems) - [misc] Allow custom token for WhitespaceRule -
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=251224
 *******************************************************************************/
...
/**
 * An implementation of <code>IRule</code> capable of detecting whitespace. A whitespace rule uses a whitespace detector
 * in order to find out which characters are whitespace characters.
 * 
...
public class WhitespaceRule implements IRule
{
    ...
    /**
     * Creates a rule which, with the help of an whitespace detector, will return {@link Token#WHITESPACE} when a
    ...
    /**
     * Creates a rule which, with the help of an whitespace detector, will return the given whitespace token when a
     * whitespace is detected.
     * 
     * @param detector the rule's whitespace detector
     ...
     * {@inheritDoc}
     * 
     * @return {@link #fWhitespaceToken} if whitespace got detected, {@link Token#UNDEFINED} otherwise
     */
