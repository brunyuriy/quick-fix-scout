...
public class MultiLineRule extends PatternRule
{
    ...
    /**
     * Creates a rule for the given starting and ending sequence which, if detected, will return the specific token. Any
     * character which follows the given escape character will be ignored.
     * 
     * @param startSequence the pattern's start sequence
     * @param endSequence the pattern's end sequence
     * @param token the token to be returned on success
    ...
    /**
     * Creates a rule for the given starting and ending sequence which, if detected, will return the specific token. Any
     * character that follows the given escape character will be ignored. <code>breakOnEOF</code> indicates whether EOF
     * is equivalent to detecting the <code>endSequence</code>.
     * 
     * @param startSequence the pattern's start sequence
     * @param endSequence the pattern's end sequence
     * @param token the token to be returned on success
