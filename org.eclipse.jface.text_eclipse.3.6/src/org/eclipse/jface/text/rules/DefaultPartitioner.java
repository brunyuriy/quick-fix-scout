...
/**
 * A standard implementation of a document partitioner. It uses a partition token scanner to scan the document and to
 * determine the document's partitioning. The tokens returned by the scanner are supposed to return the partition type
 * as their data. The partitioner remembers the document's partitions in the document itself rather than maintaining its
 * own data structure.
 * 
        ...
        IDocumentPartitionerExtension2, IDocumentPartitionerExtension3
{
    ...
    /*
     * @see org.eclipse.jface.text.IDocumentPartitionerExtension3#stopRewriteSession(org.eclipse.jface.text.
     * DocumentRewriteSession)
     * @since 3.1
     */
