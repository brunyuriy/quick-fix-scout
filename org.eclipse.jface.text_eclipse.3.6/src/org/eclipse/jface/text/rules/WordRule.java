 ...
 * Doug Satchwell <doug.satchwell@ymail.com> - [implementation] Performance issue with jface text WordRule -
 * http://bugs.eclipse.org/277299
 *******************************************************************************/
...
/**
 * An implementation of {@link IRule} capable of detecting words. A word rule also allows to associate a token to a
 * word. That is, not only can the rule be used to provide tokens for exact matches, but also for the generalized notion
