...
/**
 * A specific single line rule which stipulates that the start and end sequence occur within a single word, as defined
 * by a word detector.
 * 
 * @see IWordDetector
 */
public class WordPatternRule extends SingleLineRule
{
    ...
    /**
     * Creates a rule for the given starting and ending word pattern which, if detected, will return the specified
     * token. A word detector is used to identify words.
     * 
    ...
    /**
     * /** Creates a rule for the given starting and ending word pattern which, if detected, will return the specified
     * token. A word detector is used to identify words. Any character which follows the given escapeCharacter will be
     * ignored.
     * 
     * @param detector the word detector to be used
     * @param startSequence the start sequence of the word pattern
    ...
    /**
     * Returns whether the end sequence was detected. The rule acquires the rest of the word, using the provided word
     * detector, and tests to determine if it ends with the end sequence.
     * 
    ...
    /**
     * Returns the characters in the buffer to the scanner. Note that the rule must also return the characters read in
     * as part of the start sequence expect the first one.
     * 
     * @param scanner the scanner to be used
     */
