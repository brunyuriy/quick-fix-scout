...
/**
 * A buffered rule based scanner. The buffer always contains a section of a fixed size of the document to be scanned.
 * Completely adheres to the contract of <code>RuleBasedScanner</code>.
 */
public class BufferedRuleBasedScanner extends RuleBasedScanner
{
    ...
    /**
     * Creates a new buffered rule based scanner which does not have any rule and a default buffer size of 500
     * characters.
     */
    ...
    /**
     * Creates a new buffered rule based scanner which does not have any rule. The buffer size is set to the given
