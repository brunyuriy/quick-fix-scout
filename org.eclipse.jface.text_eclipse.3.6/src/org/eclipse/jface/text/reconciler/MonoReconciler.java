 ...
 * single {@linkplain org.eclipse.jface.text.reconciler.IReconcilingStrategy reconciling strategy} that is used
...
public class MonoReconciler extends AbstractReconciler
{
    ...
    /**
     * Creates a new reconciler that uses the same reconciling strategy to reconcile its document independent of the
     * type of the document's contents.
     * 
