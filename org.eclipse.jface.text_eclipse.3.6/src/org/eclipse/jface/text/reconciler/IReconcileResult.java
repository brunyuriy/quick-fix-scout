...
/**
 * Tagging interface for the {@linkplain org.eclipse.jface.text.reconciler.IReconcileStep reconcile step} result's array
 * element type.
 * <p>
 * This interface must be implemented by clients that want to let one of their model elements be part of a reconcile
 * step result.
 * </p>
 * 
