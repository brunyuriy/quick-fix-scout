...
/**
 * Queue used by {@link org.eclipse.jface.text.reconciler.AbstractReconciler} to manage dirty regions. When a dirty
 * region is inserted into the queue, the queue tries to fold it into the neighboring dirty region.
 * 
