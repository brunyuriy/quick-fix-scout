...
/**
 * Extends {@link org.eclipse.jface.text.information.IInformationProvider} with the ability to provide the element for a
 * given subject.
 * 
...
{
    /**
     * Returns the element for the given subject or <code>null</code> if no element is available.
     * <p>
