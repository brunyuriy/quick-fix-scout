 ...
 * <code>IInformationPresenter</code> is a {@link org.eclipse.jface.text.ITextViewer} add-on.
 * <p>
 * An information presenters has a list of {@link org.eclipse.jface.text.information.IInformationProvider} objects each
 * of which is registered for a particular document content type. The presenter uses the strategy objects to retrieve
 * the information to present.
 * </p>
 * <p>
 * In order to provide backward compatibility for clients of <code>IInformationPresenter</code>, extension interfaces
 * are used to provide a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link IInformationPresenterExtension} since version 3.0 introducing the ability to handle documents with
...
{
    /**
     * Installs the information presenter on the given text viewer. After this method has been finished, the presenter
     * is operational, i.e. the method {@link #showInformation()} can be called until {@link #uninstall()} is called.
     * 
