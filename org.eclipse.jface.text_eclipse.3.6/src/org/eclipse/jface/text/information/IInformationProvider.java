 ...
 * <p>
 * In order to provide backward compatibility for clients of <code>IInformationProvider</code>, extension interfaces are
 * used to provide a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link IInformationProviderExtension} since version 2.1 introducing the ability to provide the element for a
 * given subject</li>
 * <li>{@link IInformationProviderExtension2} since version 3.0 introducing the ability to provide its own information
 * control creator</li>
 * </ul>
 * </p>
 * <p>
...
{
    /**
     * Returns the region of the text viewer's document close to the given offset that contains a subject about which
     * information can be provided.
     * <p>
     * For example, if information can be provided on a per code block basis, the offset should be used to find the
     * enclosing code block and the source range of the block should be returned.
     * 
    ...
    /**
     * Returns the information about the given subject or <code>null</code> if no information is available. It depends
     * on the concrete configuration in which format the information is to be provided. For example, information
     * presented in an information control displaying HTML, should be provided in HTML.
     * 
