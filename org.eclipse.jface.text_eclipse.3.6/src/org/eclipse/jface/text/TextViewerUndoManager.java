...
/**
 * Implementation of {@link org.eclipse.jface.text.IUndoManager} using the shared document undo manager.
 * <p>
 * It registers with the connected text viewer as text input listener, and obtains its undo manager from the current
 * document. It also monitors mouse and keyboard activities in order to partition the stream of text changes into
 * undo-able edit commands.
 * <p>
...
public class TextViewerUndoManager implements IUndoManager, IUndoManagerExtension
{
    ...
    {
        if (isConnected()) { return fDocumentUndoManager.getUndoContext(); }
        return null;
    }
