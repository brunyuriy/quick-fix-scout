...
/**
 * A mark selection can be sent out by text viewers. By checking the type of the selection selection listeners can
 * determine whether a selection event is about a mark or a normal text selection.
 * <p>
 * This interface is not intended to be implemented by clients other than {@link org.eclipse.jface.text.ITextViewer}
 * implementers.
 * </p>
 * 
 * @since 2.0
...
public interface IMarkSelection extends ISelection
{
    ...
    /**
     * Returns the length of the mark selection. The length may be negative, if the caret is before the mark position.
     * The length has no meaning if <code>getOffset()</code> returns <code>-1</code>.
     * 
