/*******************************************************************************
 * Copyright (c) 2008, 2009 IBM Corporation and others. All rights reserved. This program and the accompanying materials
 ...
 * Cagatay Calli <ccalli@gmail.com> - [find/replace] retain caps when replacing -
 ...
 * </p>
 * <p>
 * <strong>Note:</strong> Clients must not make any assumptions about the returned proposals. This can change from
 * release to release to adapt to changes made in {@link FindReplaceDocumentAdapter}.
 * </p>
 * 
 * @since 3.4
 */
public class FindReplaceDocumentAdapterContentProposalProvider implements IContentProposalProvider
{
    ...
    private static class ProposalComputer
    {
         ...
         * 
         * @param proposal the string to be inserted
         * @param cursorPosition the cursor position after insertion, relative to the start of the proposal
         * @param displayString the proposal's label
         * @param additionalInfo the additional information
         */
        ...
        private void addBracketProposal(String proposal, int cursorPosition, String displayString, String additionalInfo)
        {
            ...
            for (int i = 1; i <= cursorPosition; i++)
            {
                ...
                if (prolog.endsWith(prefix))
                {
                    ...
                    {
                        fPriorityProposals.add(new ContentProposal(proposal.substring(i, cursorPosition),
                                displayString, additionalInfo, cursorPosition - i));
                    }
                    else
                    {
                        fPriorityProposals.add(new ContentProposal(proposal.substring(i), displayString,
     ...
     * 
     * @param isFind <code>true</code> if the provider is used for the 'find' field <code>false</code> if the provider
     *            is used for the 'replace' field
     */
