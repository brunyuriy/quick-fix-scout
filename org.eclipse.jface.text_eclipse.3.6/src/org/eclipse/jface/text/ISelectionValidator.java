...
/**
 * A selection validator allows clients to test whether the selection they received during selection changed
 * notification is valid.
 * <p>
 * For example, selection and document changes that occur between the original selection and the point in time the
 * validator is called cause the selection to be invalid.
 * </p>
 * <p>
