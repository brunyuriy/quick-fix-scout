...
/**
 * A text double click strategy defines the reaction of a text viewer to mouse double click events. The strategy must be
 * installed on an {@link org.eclipse.jface.text.ITextViewer}.
 * <p>
 * Clients may implement this interface or use the standard implementation <code>DefaultTextDoubleClickStrategy</code>.
 * </p>
 * 
