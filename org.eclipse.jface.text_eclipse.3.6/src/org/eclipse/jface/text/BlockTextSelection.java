...
public class BlockTextSelection extends TextSelection implements IBlockTextSelection
{
     ...
     * @param startColumn the possibly virtual start column, measured in characters from the start of
     *            <code>startLine</code>
     * @param endLine the inclusive end line
     * @param endColumn the exclusive and possibly virtual end column, measured in characters from the start of
     *            <code>endLine</code>
     * @param tabWidth the tabulator width used to compute the visual offsets from character offsets
     */
    public BlockTextSelection(IDocument document, int startLine, int startColumn, int endLine, int endColumn,
            int tabWidth)
    {
        super(document, computeOffset(document, startLine, startColumn), computeOffset(document, endLine, endColumn)
                - computeOffset(document, startLine, startColumn));
    ...
    /**
     * Returns the document offset for a given tuple of line and column count. If the column count points beyond the end
     * of the line, the end of the line is returned (virtual location). If the line points beyond the number of lines,
     * the end of the document is returned; if the line is &lt; zero, 0 is returned.
     * 
