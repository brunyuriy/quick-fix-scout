...
/**
 * Manages the life cycle, visibility, layout, and contents of an {@link org.eclipse.jface.text.IInformationControl}.
 * This manager can be installed on and removed from a control, referred to as the subject control, i.e. the one from
 * which the subject of the information to be shown is retrieved. Also a manager can be enabled or disabled. An
 * installed and enabled manager can be forced to show information in its information control using
 * <code>showInformation</code>. An information control manager uses an <code>IInformationControlCloser</code> to define
 * the behavior when a presented information control must be closed. The disposal of the subject and the information
 * control are internally handled by the information control manager and are not the responsibility of the information
 * control closer.
 * 
...
abstract public class AbstractInformationControlManager
{
    ...
    /**
     * Interface of an information control closer. An information control closer monitors its information control and
     * its subject control and closes the information control if necessary.
     * <p>
    ...
    {
        /**
         * Sets the closer's subject control. This is the control that parents the information control and from which
         * the subject of the information to be shown is retrieved.
         * <p>
         * Must be called before <code>start</code>. May again be called between <code>start</code> and
         * <code>stop</code>.
         * 
        ...
        /**
         * Tells this closer to start monitoring the subject and the information control. The presented information is
         * considered valid for the given area of the subject control's display.
         * 
    ...
    public static final class Anchor
    {
        ...
        /**
         * Returns the SWT direction flag. One of {@link SWT#BOTTOM}, {@link SWT#TOP}, {@link SWT#LEFT},
         * {@link SWT#RIGHT}, {@link SWT#CENTER},
         * 
    ...
    private final static Anchor [] ANCHORS = {new Anchor(SWT.TOP), new Anchor(SWT.BOTTOM), new Anchor(SWT.LEFT),
            new Anchor(SWT.RIGHT)};
    ...
    /**
     * The information control replacer to be used when this information control needs to be replaced with another
     * information control.
     * 
     * @since 3.4
     */
    ...
    /**
     * The anchor sequence used to layout the information control if the original anchor can not be used because the
     * information control would not fit in the display client area.
     * <p>
     * The fallback anchor for a given anchor is the one that comes directly after the given anchor or is the first one
     * in the sequence if the given anchor is the last one in the sequence.
     * <p>
     * </p>
     * Note: This sequence is ignored if the original anchor is not contained in this sequence. </p>
     * 
     * @see #fAnchor
     */
    ...
    /**
     * Tells whether the control's location should be read from the dialog settings and whether the last valid control's
     * size is stored back into the settings.
     * 
     * @since 3.0
     */
    private boolean fIsRestoringLocation;
    /**
     * Tells whether the control's size should be read from the dialog settings and whether the last valid control's
     * size is stored back into the settings.
     * 
     * @since 3.0
     */
    ...
    /**
     * Creates a new information control manager using the given information control creator. By default the following
    ...
    /**
     * Computes the information to be displayed and the area in which the computed information is valid. Implementation
     * of this method must finish their computation by setting the computation results using <code>setInformation</code>
     * .
     */
    abstract protected void computeInformation();

    /**
     * Sets the parameters of the information to be displayed. These are the information itself and the area for which
     * the given information is valid. This so called subject area is a graphical region of the information control's
     * subject control. This method calls <code>presentInformation()</code> to trigger the presentation of the computed
     * information.
     * 
     ...
     * 
     * @param replacer the information control replacer for this manager, or <code>null</code> if no information control
     *            replacing should take place
     * @since 3.4
     */
    ...
    /**
     * Sets the horizontal and vertical margin to be used when laying out the information control relative to the
     * subject control.
     * 
     ...
     * <p>
     * Note: This API is only valid if the information control implements {@link IInformationControlExtension3}. Not
     * following this restriction will later result in an {@link UnsupportedOperationException}.
     * </p>
     * <p>
    ...
    /**
     * Sets the anchor used for laying out the information control relative to the subject control. E.g, using
     * <code>ANCHOR_TOP</code> indicates that the information control is position above the area for which the
     * information to be displayed is valid.
     * 
    ...
    /**
     * Sets the anchors fallback sequence used to layout the information control if the original anchor can not be used
     * because the information control would not fit in the display client area.
     * <p>
     * The fallback anchor for a given anchor is the one that comes directly after the given anchor or is the first one
     * in the sequence if the given anchor is the last one in the sequence.
     * <p>
     * </p>
     * Note: This sequence is ignored if the original anchor is not contained in this list. </p>
     * 
    ...
    protected void setCustomInformationControlCreator(IInformationControlCreator informationControlCreator)
    {
        if (informationControlCreator != null
                && fCustomInformationControlCreator instanceof IInformationControlCreatorExtension)
        {
    ...
    /**
     * Handles the disposal of the subject control. By default, the information control is disposed by calling
     * <code>disposeInformationControl</code>. Subclasses may extend this method.
     */
    ...
    /**
     * Installs this manager on the given control. The control is now taking the role of the subject control. This
     * implementation sets the control also as the information control closer's subject control and automatically
     * enables this manager.
     * 
    ...
    /**
     * Computes the size constraints of the information control in points based on the default font of the given subject
     * control as well as the size constraints in character width.
     * 
     * @param subjectControl the subject control
    ...
    /**
     * Returns the information control. If the information control has not been created yet, it is automatically
     * created.
     * 
    ...
    /**
     * Computes the display location of the information control. The location is computed considering the given subject
     * area, the anchor at the subject area, and the size of the information control. This method does not care about
     * whether the information control would be completely visible when placed at the result location.
     * 
     * @param subjectArea the subject area
     ...
     * @param anchor the anchor at the subject area
     * @return the area available at the given anchor relative to the subject area, confined to the monitor's client
     *         area
     * @since 3.3
     */
    ...
    /**
     * Checks whether a control of the given size at the given location would be completely visible in the given display
     * area when laid out by using the given anchor. If not, this method tries to shift the control orthogonal to the
     * direction given by the anchor to make it visible. If possible it updates the location.
     * <p>
     * This method returns <code>true</code> if the potentially updated position results in a completely visible
     * control, or <code>false</code> otherwise.
     * 
     ...
     * <p>
     * The fallback anchor for the given anchor is the one that comes directly after the given anchor or is the first
     * one in the sequence if the given anchor is the last one in the sequence.
     * </p>
     * <p>
     * Note: It is the callers responsibility to prevent an endless loop i.e. to test whether a given anchor has already
     * been used once. then
     * </p>
     * 
    ...
    /**
     * Computes the location of the information control depending on the subject area and the size of the information
     * control. This method attempts to find a location at which the information control lies completely in the
     * display's client area while honoring the manager's default anchor. If this isn't possible using the default
     * anchor, the fallback anchors are tried out.
     * 
    ...
    /**
     * Copied from org.eclipse.jface.window.Window. Returns the monitor whose client area contains the given point. If
     * no monitor contains the point, returns the monitor that is closest to the point. If this is ever made public, it
     * should be moved into a separate utility class.
     * 
    ...
    /**
     * Computes information to be displayed as well as the subject area and initiates that this information is presented
     * in the information control. This happens only if this controller is enabled.
     */
    ...
    /**
     * Presents the information in the information control or hides the information control if no information should be
     * presented. The information has previously been set using <code>setInformation</code>.
     * <p>
    ...
    /**
     * Shows the information control and starts the information control closer. This method may not be called by
     * clients.
     * 
     * @param subjectArea the information area
     */
    ...
    /**
     * Replaces this manager's information control as defined by the information control replacer. <strong>Must only be
     * called when {@link #fInformationControl} instanceof {@link IInformationControlExtension3}!</strong>
     * 
    ...
    void replaceInformationControl(boolean takeFocus)
    {
        if (fInformationControlReplacer != null && canReplace(fInformationControl))
        {
            ...
            IInformationControlCreator informationPresenterControlCreator = ((IInformationControlExtension5) fInformationControl)
                    .getInformationPresenterControlCreator();
            fInformationControlReplacer.replaceInformationControl(informationPresenterControlCreator, contentBounds,
                    fInformation, fSubjectArea, takeFocus);
        }
        hideInformationControl();
    }
    ...
    /**
     * Disposes this manager and if necessary all dependent parts such as the information control. For symmetry it first
     * disables this manager.
     */
    public void dispose()
    {
        if (!fDisposed)
