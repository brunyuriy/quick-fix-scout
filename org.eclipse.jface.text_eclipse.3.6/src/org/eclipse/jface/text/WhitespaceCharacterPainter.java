/*******************************************************************************
 * Copyright (c) 2006, 2009 Wind River Systems, Inc., IBM Corporation and others. All rights reserved. This program and
 * the accompanying materials are made available under the terms of the Eclipse Public License v1.0 which accompanies
 * this distribution, and is available at http://www.eclipse.org/legal/epl-v10.html Contributors: Anton Leherbauer (Wind
 * River Systems) - initial API and implementation - https://bugs.eclipse.org/bugs/show_bug.cgi?id=22712 Anton
 * Leherbauer (Wind River Systems) - [painting] Long lines take too long to display when "Show Whitespace Characters" is
 * enabled - https://bugs.eclipse.org/bugs/show_bug.cgi?id=196116 Anton Leherbauer (Wind River Systems) - [painting]
 * Whitespace characters not drawn when scrolling to right slowly - https://bugs.eclipse.org/bugs/show_bug.cgi?id=206633
...
public class WhitespaceCharacterPainter implements IPainter, PaintListener
{
    ...
    /**
     * Returns <code>true</code> if <code>offset</code> is selection in <code>widget</code>, <code>false</code>
     * otherwise.
     * 
