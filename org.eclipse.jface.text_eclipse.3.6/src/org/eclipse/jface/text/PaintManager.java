 ...
 * @since 2.1
 */
public final class PaintManager implements KeyListener, MouseListener, ISelectionChangedListener, ITextListener,
        ITextInputListener
{
    /**
     * Position updater used by the position manager. This position updater differs from the default position updater in
     * that it extends a position when an insertion happens at the position's offset and right behind the position.
     */
    static class PaintPositionUpdater extends DefaultPositionUpdater
    {
        ...
        /**
         * If an insertion happens at a position's offset, the position is extended rather than shifted. Also, if
         * something is added right behind the end of the position, the position is extended rather than kept stable.
         */
    ...
    /**
     * The paint position manager used by this paint manager. The paint position manager is installed on a single
     * document and control the creation/disposed and updating of a position category that will be used for managing
     * positions.
     */
    static class PositionManager implements IPaintPositionManager
    {
        ...
        /**
         * Creates a new position manager. Initializes the managing position category using its class name and its hash
         * value.
         */
        ...
        /**
         * Disposes this position manager. The position manager is automatically removed from the document it has
        ...
        /**
         * Uninstalls this position manager form the given document. If the position manager has no been installed on
         * this document, this method is without effect.
         * 
    ...
    /**
     * Adds the given painter to the list of painters managed by this paint manager. If the painter is already
     * registered with this paint manager, this method is without effect.
     * 
    ...
    /**
     * Removes the given painter from the list of painters managed by this paint manager. If the painter has not
     * previously been added to this paint manager, this method is without effect.
     * 
    ...
    /**
     * Installs/activates this paint manager. Is called as soon as the first painter is to be managed by this paint
     * manager.
     */
    ...
    /**
     * Disposes this paint manager. The paint manager uninstalls itself and clears all registered painters. This method
     * is also called when the last painter is removed from the list of managed painters.
     */
    public void dispose()
    {
        if (fManager != null)
    ...
    /**
     * Removes our set of listeners from the text viewer and widget, respectively.
     */
