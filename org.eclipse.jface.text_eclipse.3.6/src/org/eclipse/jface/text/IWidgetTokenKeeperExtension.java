 ...
 * <p>
 * Replaces the original <code>requestWidgetToken</code> functionality with a new priority based approach. Adds the
 * concept of focus handling.
 * 
 * @since 3.0
 */
public interface IWidgetTokenKeeperExtension
{
     ...
     * <p>
     * The general contract is that the receiver should release the token if <code>priority</code> exceeds the
     * receiver's priority.
     * </p>
     * 
    ...
    /**
     * Requests the receiver to give focus to its popup shell, hover, or similar. There is no assumption made whether
     * the receiver actually succeeded in taking the focus. The return value gives a hint whether the receiver tried to
     * take focus.
     * 
     * @param owner the token owner
