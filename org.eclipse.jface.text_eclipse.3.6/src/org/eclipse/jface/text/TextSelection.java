 ...
 * <p>
 * Takes advantage of the weak contract of correctness of its interface. If generated from a selection provider, it only
 * remembers its offset and length and computes the remaining information on request.
 * </p>
 */
public class TextSelection implements ITextSelection
{
    ...
    /**
     * Creates a text selection for the given range. This selection object describes generically a text range and is
     * intended to be an argument for the <code>setSelection</code> method of selection providers.
     * 
    ...
    /**
     * Creates a text selection for the given range of the given document. This selection object is created by selection
