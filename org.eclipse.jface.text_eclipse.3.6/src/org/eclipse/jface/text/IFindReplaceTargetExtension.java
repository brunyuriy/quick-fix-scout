 ...
 * <p>
 * If a scope is set, <code>findAndSelect</code> is limited to the scope. Occurrences outside of the scope are not
 * considered.
 * 
 * @since 2.0
 */
...
{
    /**
     * Indicates that a session with the target begins. All calls except <code>beginSession()</code> and
     * <code>endSession()</code> to <code>IFindReplaceTarget</code> and <code>IFindReplaceTargetExtension</code> must be
     * embedded within calls to <code>beginSession()</code> and <code>endSession()</code>.
     * 
     * @see #endSession()
     */
    void beginSession();
    ...
    /**
     * Sets the find scope of the target to operate on. <code>null</code> indicates that the global scope should be
     * used.
     * 
     ...
     * 
     * @param replaceAll <code>true</code> if this target should switch into replace-all mode, <code>false</code> if it
     *            should leave the replace-all state
     */
