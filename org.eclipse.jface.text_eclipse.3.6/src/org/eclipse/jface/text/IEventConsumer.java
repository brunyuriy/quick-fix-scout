...
/**
 * Implementers can register with a text viewer and receive <code>VerifyEvent</code>s before the text viewer they are
 * registered with. If the event consumer marks events as processed by turning their <code>doit</code> field to
 * <code>false</code> the text viewer subsequently ignores them.</p>
 * <p>
 * Clients may implement this interface.
 * </p>
 * <p>
 * {@link org.eclipse.jface.text.ITextViewerExtension2}allows clients to manage the
 * {@link org.eclipse.swt.events.VerifyListener}s of a text viewer. This makes <code>IEventConsumer</code> obsolete.
 * </p>
 * 
