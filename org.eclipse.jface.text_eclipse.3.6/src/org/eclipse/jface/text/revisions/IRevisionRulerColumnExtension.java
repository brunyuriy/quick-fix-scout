...
public interface IRevisionRulerColumnExtension
{
     ...
     * <p>
     * Currently the most recent revision is red, the oldest is a faint yellow. The coloring scheme can change in future
     * releases.
     * </p>
     */
    RenderingMode AGE = new RenderingMode("Age"); //$NON-NLS-1$
    /**
     * Rendering mode that assigns unique colors per revision author and uses different color intensity depending on the
     * age.
     * <p>
     * Currently it selects lighter colors for older revisions and more intense colors for more recent revisions. The
     * coloring scheme can change in future releases.
     * </p>
     */
    ...
    /**
     * Removes a previously registered revision listener; nothing happens if <code>listener</code> was not registered
     * with the receiver.
     * 
