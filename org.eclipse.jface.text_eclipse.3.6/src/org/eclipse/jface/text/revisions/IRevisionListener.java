...
{
    /**
     * Notifies the receiver that the revision information has been updated. This typically occurs when revision
     * information is being displayed in an editor and the annotated document is modified.
     * 
