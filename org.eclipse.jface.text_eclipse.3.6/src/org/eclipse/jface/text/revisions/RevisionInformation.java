...
public final class RevisionInformation implements ITextHoverExtension, IInformationProviderExtension2
{
    ...
    /**
     * The flattened list of {@link RevisionRange}s, unmodifiable. <code>null</code> if the list must be re-computed.
     * 
     * @since 3.3
     */
    ...
    /**
     * Returns the line ranges of this revision information. The returned information is only valid at the moment it is
     * returned, and may change as the annotated document is modified. See {@link IRevisionListener} for a way to be
     * informed when the revision information changes. The returned list is sorted by document offset.
     * 
     ...
     * <strong>Note:</strong> This is an internal framework method and must not be called by clients.
     * 
     ...
     * <p>
     * <strong>Note:</strong> The created information control must be able to display the object returned by the
     * concrete implementation of {@link Revision#getHoverInfo()}.
     * </p>
     * 
