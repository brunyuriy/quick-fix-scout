...
public abstract class Revision
{
    ...
    /**
     * The cached list of adjusted ranges, element type: {@link RevisionRange}. <code>null</code> if the list must be
     * re-computed. Unmodifiable.
     * 
     * @since 3.3
     */
    ...
    /**
     * Returns the contained {@link RevisionRange}s adapted to the current diff state. The returned information is only
     * valid at the moment it is returned, and may change as the annotated document is modified.
     * 
    ...
    /**
     * Adjusts the revision information to the given diff information. Any previous diff information is discarded.
     * 
     ...
     * <p>
     * <strong>Note:</strong> The hover information control which is used to display the information must be able
     * process the given object. If the default information control creator is used the supported format is simple text,
     * full HTML or an HTML fragment.
     * </p>
     * 
    ...
    /**
     * Returns the author color for this revision. This color can be used to visually distinguish one revision from
     * another, for example as background color.
     * <p>
     * Revisions from the same author must return the same color and revisions from different authors must return
     * distinct colors.
     * </p>
     * 
    ...
    /**
     * Returns the unique (within the document) id of this revision. This may be the version string or a different
     * identifier.
     * 
