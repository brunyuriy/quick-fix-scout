...
public class MarginPainter implements IPainter, PaintListener
{
    ...
    /**
     * Initializes this painter, by flushing and recomputing all caches and causing the widget to be redrawn. Must be
     * called explicitly when font of text widget changes.
     */
