...
/**
 * An <code>IContentAssistant</code> provides support on interactive content completion. The content assistant is a
 * {@link org.eclipse.jface.text.ITextViewer} add-on. Its purpose is to propose, display, and insert completions of the
 * content of the text viewer's document at the viewer's cursor position. In addition to handle completions, a content
 * assistant can also be requested to provide context information. Context information is shown in a tool tip like
 * popup. As it is not always possible to determine the exact context at a given document offset, a content assistant
 * displays the possible contexts and requests the user to choose the one whose information should be displayed.
 * <p>
 * A content assistant has a list of {@link org.eclipse.jface.text.contentassist.IContentAssistProcessor} objects each
 * of which is registered for a particular document content type. The content assistant uses the processors to react on
 * the request of completing documents or presenting context information.
 * </p>
 * <p>
 * In order to provide backward compatibility for clients of <code>IContentAssistant</code>, extension interfaces are
 * used to provide a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link org.eclipse.jface.text.contentassist.IContentAssistantExtension} since version 3.0 introducing the
 * following functions:
 * <ul>
 ...
 * </ul>
 * </li>
 * <li>{@link org.eclipse.jface.text.contentassist.IContentAssistantExtension2} since version 3.2 introducing the
 * following functions:
 * <ul>
 ...
 * </ul>
 * </li>
 * <li>{@link org.eclipse.jface.text.contentassist.IContentAssistantExtension3} since version 3.2 introducing the
 * following function:
 * <ul>
 * <li>a key-sequence to listen for in repeated invocation mode</li>
 * </ul>
 * </li>
 * <li>{@link org.eclipse.jface.text.contentassist.IContentAssistantExtension4} since version 3.4 introducing the
 * following function:
 * <ul>
 ...
 * {@link org.eclipse.jface.text.contentassist.ContentAssistant} as the standard implementer of this interface.
 * </p>
 * 
...
public interface IContentAssistant
{
     ...
     * @return an instance content assist processor or <code>null</code> if none exists for the specified content type
     */
