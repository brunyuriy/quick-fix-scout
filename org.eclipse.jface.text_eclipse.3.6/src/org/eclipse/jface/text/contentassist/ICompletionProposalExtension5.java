...
/**
 * Extends {@link org.eclipse.jface.text.contentassist.ICompletionProposal} with the following function:
 * <ul>
...
{
    /**
     * Returns additional information about the proposal. The additional information will be presented to assist the
     * user in deciding if the selected proposal is the desired choice.
     * <p>
     ...
     * {@link ICompletionProposalExtension3#getInformationControlCreator()} is implemented, the information will be
     * passed to a custom information control for display.
     * </p>
     * 
     * @param monitor a monitor to report progress and to watch for {@link IProgressMonitor#isCanceled() cancelation}.
