 ...
 * <p>
 * In order to provide backward compatibility for clients of <code>IContextInformation</code>, extension interfaces are
 * used to provide a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link org.eclipse.jface.text.contentassist.IContextInformationExtension} since version 2.0 introducing the
 * ability to freely position the context information.</li>
 * </ul>
 * </p>
 * <p>
...
{
    /**
     * Returns the string to be displayed in the list of contexts. This method is used to supply a unique presentation
     * for situations where the context is ambiguous. These strings are used to allow the user to select the specific
     * context.
     * 
    ...
    /**
     * Compares the given object with this receiver. Two context informations are equal if there information display
     * strings and their context display strings are equal.
     * <p>
     * <strong>Note:</strong> As specified in {@link Object#equals(Object)} clients will most likely also have to
