...
/**
 * Extends {@link org.eclipse.jface.text.contentassist.IContentAssistant} with the following function:
 * <ul>
...
{
    /**
     * Sets the key sequence to listen for in repeated invocation mode. If the key sequence is encountered, a step in
     * the repetition iteration is triggered.
     * 
