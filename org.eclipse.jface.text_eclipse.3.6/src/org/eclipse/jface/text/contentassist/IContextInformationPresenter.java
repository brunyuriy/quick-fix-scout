...
/**
 * A context information presenter determines the presentation of context information depending on a given document
 * position.
 * <p>
...
public interface IContextInformationPresenter
{
    ...
    /**
     * Updates the given presentation of the given context information at the given document position. Returns whether
     * update changed the presentation.
     * 
