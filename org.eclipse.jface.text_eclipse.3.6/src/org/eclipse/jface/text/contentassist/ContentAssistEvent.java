 ...
 * Anton Leherbauer (Wind River Systems) - [content assist][api] ContentAssistEvent should contain information about
 * auto activation - https://bugs.eclipse.org/bugs/show_bug.cgi?id=193728
 *******************************************************************************/
...
public final class ContentAssistEvent
{
     ...
     * <p>
     * <strong>Note:</strong> This flag is only valid in
     * {@link ICompletionListener#assistSessionStarted(ContentAssistEvent)}.
     * </p>
     * 
     * @since 3.4
     */
