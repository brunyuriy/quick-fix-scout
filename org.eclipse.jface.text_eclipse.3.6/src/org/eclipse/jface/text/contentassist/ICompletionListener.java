 ...
 * <p>
 * In order to provide backward compatibility for clients of <code>ICompletionListener</code>, extension interfaces are
 * used to provide a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link org.eclipse.jface.text.contentassist.ICompletionListenerExtension} since version 3.4 introducing the
 * following functions:
 * <ul>
...
public interface ICompletionListener
{
     ...
     * @param smartToggle <code>true</code> if the insert-mode toggle is being pressed, <code>false</code> otherwise
     */
