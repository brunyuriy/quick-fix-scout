...
/**
 * A default implementation of the <code>IContextInfomationValidator</code> interface. This implementation determines
 * whether the information is valid by asking the content assist processor for all context information objects for the
 * current position. If the currently displayed information is in the result set, the context information is considered
 * valid.
 */
