...
/**
 * Extends {@link org.eclipse.jface.text.contentassist.IContentAssistant} with the following functions:
 * <ul>
...
public interface IContentAssistantExtension2
{
    ...
    /**
     * Enables repeated invocation mode, which will trigger re-computation of the proposals when code assist is executed
     * repeatedly. The default is no <code>false</code>.
     * 
    ...
    /**
     * Sets the text to be shown if no proposals are available and {@link #setShowEmptyList(boolean) empty lists} are
     * displayed.
     * 
