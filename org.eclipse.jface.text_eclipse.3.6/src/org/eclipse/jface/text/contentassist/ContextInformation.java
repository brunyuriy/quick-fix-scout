...
public final class ContextInformation implements IContextInformation
{
     ...
     * @param contextDisplayString the string to be used when presenting the context
     * @param informationDisplayString the string to be displayed when presenting the context information, may not be
     *            <code>null</code>
     */
    ...
    public boolean equals(Object object)
    {
        if (object instanceof IContextInformation)
        {
            ...
            boolean equals = fInformationDisplayString.equalsIgnoreCase(contextInformation
