...
public interface ICompletionProposalExtension
{
     ...
     * character at the given offset. This method assumes that {@link #isValidFor(IDocument, int)} returns
     ...
     * 
     * @return the completion characters for this completion proposal or <code>null</code> if no completion other than
     *         the new line character is possible
     */
    char [] getTriggerCharacters();

    /**
     * Returns the position to which the computed context information refers to or <code>-1</code> if no context
     * information can be provided by this completion proposal.
     * 
