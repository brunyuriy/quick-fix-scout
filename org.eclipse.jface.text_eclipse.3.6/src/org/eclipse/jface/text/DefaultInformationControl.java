 ...
 * <p>
 * Displays textual information in a {@link org.eclipse.swt.custom.StyledText} widget. Before displaying, the
 * information set to this information control is processed by an <code>IInformationPresenter</code>.
 * 
 * @since 2.0
 */
public class DefaultInformationControl extends AbstractInformationControl implements DisposeListener
{
    ...
    public interface IInformationPresenter
    {
         ...
         *             {@link DefaultInformationControl.IInformationPresenterExtension#updatePresentation(Drawable, String, TextPresentation, int, int)}
         */
     ...
     * @deprecated As of 3.4, replaced by simpler constructors
     */
    public DefaultInformationControl(Shell parentShell, int shellStyle, final int style,
    ...
    protected void createContent(Composite parent)
    {
        ...
        {
            // indent does not work for wrapping StyledText, see https://bugs.eclipse.org/bugs/show_bug.cgi?id=56342 and
    ...
    public void setInformation(String content)
    {
        ...
        else
        {
            ...
            if (constraints != null)
            {
                ...
                maxWidth -= fText.getCaret().getSize().x; // StyledText adds a border at the end of the line for the
                                                          // caret.
            }
            if (isResizable())
    ...
    public IInformationControlCreator getInformationPresenterControlCreator()
    {
        return new IInformationControlCreator()
        {
            /*
             * @see
             * org.eclipse.jface.text.IInformationControlCreator#createInformationControl(org.eclipse.swt.widgets.Shell)
             */
