...
public class DefaultAnnotationHover implements IAnnotationHover
{
    ...
    public String getHoverInfo(ISourceViewer sourceViewer, int lineNumber)
    {
        ...
        if (fShowLineNumber && lineNumber > -1)
            return JFaceTextMessages.getFormattedString(
                    "DefaultAnnotationHover.lineNumber", new String [] {Integer.toString(lineNumber + 1)}); //$NON-NLS-1$
        return null;
    }
    ...
    protected String formatMultipleMessages(List messages)
    {
        ...
        while (e.hasNext())
        {
            ...
            buffer.append(JFaceTextMessages.getFormattedString(
                    "DefaultAnnotationHover.listItem", new String [] {listItemText})); //$NON-NLS-1$
        }
