 ...
 * Nikolay Botev <bono8106@hotmail.com> - [projection] Editor loses keyboard focus when expanding folded region -
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=184255
 *******************************************************************************/
...
public class AnnotationRulerColumn implements IVerticalRulerColumn, IVerticalRulerInfo, IVerticalRulerInfoExtension
{
    ...
    /**
     * Pair of an annotation and their associated position. Used inside the paint method for sorting annotations based
     * on the offset of their position.
     * 
     * @since 3.0
     */
    ...
    /**
     * The list of allowed annotation types to be shown in this ruler. An allowed annotation type maps to
     * <code>true</code>, a disallowed to <code>false</code>.
     * 
     * @since 3.0
     */
    ...
    /**
     * Draws the vertical ruler w/o drawing the Canvas background. Implementation based on
     * <code>ITextViewerExtension5</code>. Will replace <code>doPaint(GC)</code>.
     * 
     * @param gc the GC to draw into
     */
    protected void doPaint1(GC gc)
    {
        ...
        for (int layer = minLayer; layer <= maxLayer; layer++)
        {
            for (int i = 0, n = fCachedAnnotations.size(); i < n; i++)
            {
                ...
                if (startLine == -1)
                    continue;
                int endLine = extension.widgetLineOfWidgetOffset(widgetRegion.getOffset()
                        + Math.max(widgetRegion.getLength() - 1, 0));
                if (endLine == -1)
                    continue;
                r.x = 0;
                r.y = JFaceTextUtil.computeLineHeight(fCachedTextWidget, 0, startLine, startLine) - fScrollPos;
    ...
    /**
     * Adds the given annotation type to this annotation ruler column. Starting with this call, annotations of the given
     * type are shown in this annotation ruler column.
     * 
    ...
    /**
     * Removes the given annotation type from this annotation ruler column. Annotations of the given type are no longer
     * shown in this annotation ruler column.
     * 
     * @param annotationType the annotation type
     * @since 3.0
     */
    ...
    /**
     * Returns whether the given annotation should be skipped by the drawing routine.
     * 
     * @param annotation the annotation
     * @return <code>true</code> if annotation of the given type should be skipped, <code>false</code> otherwise
     * @since 3.0
     */
    ...
    /**
     * Computes whether the annotation of the given type should be skipped or not.
     * 
     * @param annotationType the annotation type
     * @return <code>true</code> if annotation should be skipped, <code>false</code> otherwise
     * @since 3.0
     */
