...
/**
 * Extension interface for {@link org.eclipse.jface.text.source.IVerticalRulerInfo}.
 * <p>
 * Introduces the ability to define a custom hover to be used when hovering over the vertical ruler described by this
 * info instance, and to specify the annotation model used by it.
 * <p>
 * It also allows client to register as listeners on the represented vertical ruler and sends out notifications similar
 * to selection events such as that a particular annotation presented in the vertical ruler has been selected.
 * 
...
public interface IVerticalRulerInfoExtension
{
    ...
    /**
     * Removes a previously registered listener. If <code>listener</code> is not registered with the receiver, calling
