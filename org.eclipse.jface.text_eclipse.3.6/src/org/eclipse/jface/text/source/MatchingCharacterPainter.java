...
/**
 * Highlights the peer character matching the character near the caret position. This painter can be configured with an
...
public final class MatchingCharacterPainter implements IPainter, PaintListener
{
    ...
    /**
     * Creates a new MatchingCharacterPainter for the given source viewer using the given character pair matcher. The
     * character matcher is not adopted by this painter. Thus, it is not disposed. However, this painter requires
