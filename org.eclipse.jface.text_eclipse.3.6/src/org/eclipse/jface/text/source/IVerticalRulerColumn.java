...
/**
 * A vertical ruler column is an element that can be added to a composite vertical ruler (
 * {@link org.eclipse.jface.text.source.CompositeRuler}). A composite vertical ruler is a vertical ruler with
 * dynamically changing appearance and behavior depending on its actual arrangement of ruler columns. A vertical ruler
 * column supports a subset of the contract of a vertical ruler.
 * 
...
{
    /**
     * Associates an annotation model with this ruler column. A value <code>null</code> is acceptable and clears the
     * ruler.
     * 
