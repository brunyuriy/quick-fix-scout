...
/**
 * Describes the change state of one line, which consists of the state of the line itself, which can be
 * <code>UNCHANGED</code>, <code>CHANGED</code> or <code>ADDED</code>, and the number of deleted lines before and after
 * this line.
 * <p>
...
public interface ILineDiffInfo
{
    ...
    /**
     * Returns the type of this line, one out of <code>UNCHANGED</code>, <code>CHANGED</code> or <code>ADDED</code>.
     * 
     ...
     * 
     * @return <code>true</code>, if the line's state (as returned by <code>getType</code>) is either
     *         <code>CHANGED</code> or <code>ADDED</code> or either of <code>getRemovedLinesBelow</code> and
     *         <code>getRemovedLinesAbove</code> would return a number &gt; 0
     */
    boolean hasChanges();
     ...
     * 
     * @return the original text of this changed region, including any deleted lines. The returned value and its
     *         elements may not be <code>null/code>, it may however be of zero length
     */
