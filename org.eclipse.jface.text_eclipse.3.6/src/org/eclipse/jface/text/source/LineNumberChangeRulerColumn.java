 ...
 * @since 3.0
 */
public final class LineNumberChangeRulerColumn extends LineNumberRulerColumn implements IChangeRulerColumn,
        IRevisionRulerColumn, IRevisionRulerColumnExtension
{
     ...
     * 
     * @param showNumbers <code>true</code> to show numbers, <code>false</code> to only show diff / revision info.
     * @since 3.3
     */
