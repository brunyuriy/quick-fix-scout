 ...
 * <code>configure</code> method of <code>ISourceViewer</code>.
 * <p>
 * Each method in this class get as argument the source viewer for which it should provide a particular configuration
 * setting such as a presentation reconciler. Based on its specific knowledge about the returned object, the
 * configuration might share such objects or compute them according to some rules.
 * </p>
 * <p>
...
public class SourceViewerConfiguration
{
    ...
    /**
     * Returns the undo manager for the given source viewer. This implementation always returns a new instance of
    ...
    /**
     * Returns the reconciler ready to be used with the given source viewer. This implementation always returns
     * <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the content formatter ready to be used with the given source viewer. This implementation always returns
     * <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the content assistant ready to be used with the given source viewer. This implementation always returns
     * <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the quick assist assistant ready to be used with the given source viewer. This implementation always
    ...
    /**
     * Returns the auto indentation strategy ready to be used with the given source viewer when manipulating text of the
     * given content type. This implementation always returns an new instance of <code>DefaultAutoIndentStrategy</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
     ...
     */
    public org.eclipse.jface.text.IAutoIndentStrategy getAutoIndentStrategy(ISourceViewer sourceViewer,
            String contentType)
    {
    ...
    /**
     * Returns the auto edit strategies ready to be used with the given source viewer when manipulating text of the
     * given content type. For backward compatibility, this implementation always returns an array containing the result
     * of {@link #getAutoIndentStrategy(ISourceViewer, String)}.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the default prefixes to be used by the line-prefix operation in the given source viewer for text of the
     * given content type. This implementation always returns <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the double-click strategy ready to be used in this viewer when double clicking onto text of the given
     * content type. This implementation always returns a new instance of <code>DefaultTextDoubleClickStrategy</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
     * @param contentType the content type for which the strategy is applicable
    ...
    /**
     * Returns the prefixes to be used by the line-shift operation. This implementation always returns
    ...
    /**
     * Computes and returns the indent prefixes for tab indentation which is represented as <code>tabSizeInSpaces</code>
     * .
     * 
    ...
    /**
     * Returns the annotation hover which will provide the information to be shown in a hover popup window when
     * requested for the given source viewer. This implementation always returns <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the annotation hover which will provide the information to be shown in a hover popup window when
     * requested for the overview ruler of the given source viewer.This implementation always returns the general
     ...
     * @return an <code>int</code> array with the configured SWT event state masks or <code>null</code> if text hovers
     *         are not supported for the given content type
     * @since 2.1
     */
    ...
    /**
     * Returns the text hover which will provide the information to be shown in a text hover popup window when requested
     * for the given source viewer and the given content type. This implementation always returns <code>
     * null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
     * @param contentType the content type
    ...
    /**
     * Returns the information control creator. The creator is a factory creating information controls for the given
    ...
    /**
     * Returns the information presenter which will determine and shown information requested for the current cursor
     * position. This implementation always returns <code>null</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns all configured content types for the given source viewer. This list tells the caller which content types
     * must be configured for the given source viewer, i.e. for which content types the given source viewer's
     * functionalities must be specified. This implementation always returns <code>
    ...
    /**
     * Returns the configured partitioning for the given source viewer. The partitioning is used when the querying
     * content types from the source viewer's input document. This implementation always returns
     * <code>IDocumentExtension3.DEFAULT_PARTITIONING</code>.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the hyperlink detectors which be used to detect hyperlinks in the given source viewer. This
    ...
    /**
     * Returns the hyperlink presenter for the given source viewer. This implementation always returns the
     * {@link DefaultHyperlinkPresenter}.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
    ...
    /**
     * Returns the SWT event state mask which in combination with the left mouse button activates hyperlinking. This
     * implementation always returns the {@link SWT#MOD1}.
     * 
     * @param sourceViewer the source viewer to be configured by this configuration
