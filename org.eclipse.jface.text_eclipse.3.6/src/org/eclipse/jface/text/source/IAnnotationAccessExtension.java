...
public interface IAnnotationAccessExtension
{
    ...
    /**
     * Returns the layer for given annotation. Annotations are considered being located at layers and are considered
     * being painted starting with layer 0 upwards. Thus an annotation at layer 5 will be drawn on top of all co-located
     * annotations at the layers 4 - 0.
     * 
     * @param annotation the annotation
    ...
    /**
     * Returns <code>true</code> if painting <code>annotation</code> will produce something meaningful,
     * <code>false</code> if not. E.g. if no image is available.
     * <p>
     * <em>Note that this method is not used when drawing annotations on the editor's
     * text widget. This is handled trough a {@link org.eclipse.jface.text.source.AnnotationPainter.IDrawingStrategy}.</em>
     * </p>
    ...
    /**
     * Returns <code>true</code> if the given annotation is of the given type or <code>false</code> otherwise.
     * 
    ...
    /**
     * Returns the list of super types for the given annotation type. This does not include the type itself. The index
     * in the array of super types indicates the length of the path in the hierarchy graph to the given annotation type.
     * 
