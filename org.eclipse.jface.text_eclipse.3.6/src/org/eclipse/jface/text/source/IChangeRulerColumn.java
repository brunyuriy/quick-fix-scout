...
public interface IChangeRulerColumn extends IVerticalRulerColumn, IVerticalRulerInfoExtension
{
    ...
    /**
     * Sets the background color for normal lines. The color has to be disposed of by the caller when the receiver is no
     * longer used.
     * 
    ...
    /**
     * Sets the background color for added lines. The color has to be disposed of by the caller when the receiver is no
     * longer used.
     * 
    ...
    /**
     * Sets the background color for changed lines. The color has to be disposed of by the caller when the receiver is
     * no longer used.
     * 
    ...
    /**
     * Sets the color for the deleted lines indicator. The color has to be disposed of by the caller when the receiver
     * is no longer used.
     * 
