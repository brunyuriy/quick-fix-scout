 ...
 * issued by the overview ruler of a source viewer.
 * 
 * @since 2.1
 */
...
{
    /**
     * Creates an overview hover manager with the given parameters. In addition, the hovers anchor is RIGHT and the
     ...
     */
    public OverviewRulerHoverManager(IOverviewRuler ruler, ISourceViewer sourceViewer,
