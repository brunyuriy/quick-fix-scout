...
/**
 * Standard implementation of {@link org.eclipse.jface.text.source.IVerticalRuler}.
 * <p>
 * This ruler does not have a a visual representation of its own. The presentation comes from the configurable list of
 * vertical ruler columns. Such columns must implement the {@link org.eclipse.jface.text.source.IVerticalRulerColumn}.
 * interface.
 * </p>
 * <p>
...
public class CompositeRuler implements IVerticalRuler, IVerticalRulerExtension, IVerticalRulerInfoExtension
{
    ...
    /**
     * A canvas that adds listeners to all its children. Used by the implementation of the vertical ruler to propagate
     * listener additions and removals to the ruler's columns.
     */
    static class CompositeRulerCanvas extends Canvas
    {
        ...
        /**
         * Adds the given listener object as listener of the given type (<code>clazz</code>) to the given control.
         * 
        ...
        /**
         * Removes the given listener object as listener of the given type (<code>clazz</code>) from the given control.
         * 
         * @param clazz the listener type
        ...
        /**
         * Adds the given listener object to the internal book keeping under the given listener type (<code>clazz</code>
         * ).
         * 
         * @param clazz the listener type
        ...
        /**
         * Removes the given listener object from the internal book keeping under the given listener type (
         * <code>clazz</code>).
         * 
         * @param clazz the listener type
         * @param listener the listener object
    ...
    public int getLineOfLastMouseButtonActivity()
    {
        ...
        else if (fTextViewer.getDocument() == null
                || fLastMouseButtonActivityLine >= fTextViewer.getDocument().getNumberOfLines())
    ...
    /**
     * Returns an iterator over the <code>IVerticalRulerColumns</code> that make up this composite column.
     * 
    ...
    /**
     * Informs all registered vertical ruler listeners that the content menu on a selected annotation\ is about to be
     * shown. TODO use robust iterators
     * 
     * @param event the event to fire
