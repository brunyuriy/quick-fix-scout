 ...
 * <p>
 * Allows the source viewer to roll back a previous configuration process and allows clients access to the viewer's
...
{
    /**
     * Rolls back the configuration process of this source viewer. The source viewer can be configured again after a
     * call to this method. Unlike {@link ISourceViewer#configure(SourceViewerConfiguration)} this method can be called
     * more than once without interleaving calls to {@link ISourceViewer#configure(SourceViewerConfiguration)}.
     */
    void unconfigure();
