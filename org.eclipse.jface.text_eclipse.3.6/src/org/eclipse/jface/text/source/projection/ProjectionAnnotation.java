 ...
 * {@link org.eclipse.jface.text.projection.ProjectionDocument}. A projection annotation can be either expanded or
 * collapsed. If expanded it corresponds to a segment of the projection document. If collapsed, it represents a region
 * of the master document that does not have a corresponding segment in the projection document.
 * <p>
...
public class ProjectionAnnotation extends Annotation implements IAnnotationPresentation
{
     ...
     * initially collapsed.
     * 
     * @param isCollapsed <code>true</code> if the annotation should initially be collapsed, <code>false</code>
     *            otherwise
     */
    ...
    private void initializeImages(Display display)
    {
        if (fgCollapsedImage == null)
        {
            ImageDescriptor descriptor = ImageDescriptor.createFromFile(ProjectionAnnotation.class,
                    "images/collapsed.png"); //$NON-NLS-1$
