...
/**
 * A projection annotation model. It provides methods for modifying the expansion state of the managed projection
 * annotations.
 * <p>
...
public class ProjectionAnnotationModel extends AnnotationModel
{
     ...
     * @param offset the range offset
     * @param length the range length
     * @return <code>true</code> if any annotation has been collapse, <code>false</code> otherwise
     * @since 3.2
     */
     ...
     * @param fireModelChanged <code>true</code> if a model change event should be fired, <code>false</code> otherwise
     * @return <code>true</code> if any annotation has been expanded, <code>false</code> otherwise
     */
