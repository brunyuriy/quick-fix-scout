 ...
 * @since 3.0
 */
class SourceViewerInformationControl implements IInformationControl, IInformationControlExtension,
        IInformationControlExtension3, IInformationControlExtension5, DisposeListener
{
            ...
            String statusFieldText)
    {
        ...
        if (statusFieldText != null)
        {
            ...
            fStatusTextForegroundColor = new Color(fStatusField.getDisplay(), blend(
