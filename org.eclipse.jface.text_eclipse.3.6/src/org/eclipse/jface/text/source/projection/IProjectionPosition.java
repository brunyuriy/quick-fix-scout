...
/**
 * An <code>IProjectionPosition</code> is a position that is associated with a <code>ProjectionAnnotation</code> and
 * that is able to compute its collapsed regions. That is, if a <code>Position</code> implements this interface,
 * <code>ProjectionViewer</code> will delegate to the {@link #computeProjectionRegions(IDocument)
 * computeProjectionRegions} method when determining the document regions that should be collapsed for a certain
...
public interface IProjectionPosition
{
    ...
    /**
     * Returns the offset of the caption (the anchor region) of this projection position. The returned offset is
     * relative to the receivers offset into the document.
     * 
     * @param document the document that this position is attached to
