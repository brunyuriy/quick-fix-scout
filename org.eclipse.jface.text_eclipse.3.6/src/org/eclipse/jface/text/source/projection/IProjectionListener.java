...
/**
 * Implementers registered with a {@link org.eclipse.jface.text.source.projection.ProjectionViewer} get informed when
 * the projection mode of the viewer gets enabled and when it gets disabled.
 * 
 * @since 3.0
 */
