...
public class ProjectionSupport
{
    ...
    private static class ProjectionAnnotationsPainter extends AnnotationPainter
    {
        ...
        /*
         * @see
         * org.eclipse.jface.text.source.AnnotationPainter#findAnnotationModel(org.eclipse.jface.text.source.ISourceViewer
         * )
         */
    ...
    private static class ProjectionDrawingStrategy implements AnnotationPainter.IDrawingStrategy
    {
         ...
         * org.eclipse.swt.custom.StyledText, int, int, org.eclipse.swt.graphics.Color)
         */
     ...
     */
    public ProjectionSupport(ProjectionViewer viewer, IAnnotationAccess annotationAccess,
     ...
     * viewer. This method has only an effect when <code>addSummarizableAnnotationType</code> has been called before for
    ...
    /**
     * Sets the information presenter control creator that is used for the annotation hovers that are shown in the
     * projection viewer's projection ruler column.
     * 
     ...
     * 
     * @param strategy the drawing strategy or <code>null</code> to reset the strategy to the default
     * @since 3.1
     */
