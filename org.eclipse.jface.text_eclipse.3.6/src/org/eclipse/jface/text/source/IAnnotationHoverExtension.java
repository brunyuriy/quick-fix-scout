...
public interface IAnnotationHoverExtension
{
    ...
    /**
     * Returns whether the provided information control can interact with the mouse cursor. I.e. the hover must
     * implement custom information control management.
     * 
    ...
    /**
     * Returns the object which should be presented in the a hover popup window. The information is requested based on
