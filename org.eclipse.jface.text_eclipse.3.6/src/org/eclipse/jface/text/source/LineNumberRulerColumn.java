 ...
 * Nikolay Botev <bono8106@hotmail.com> - [rulers] Shift clicking in line number column doesn't select range -
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=32166 Nikolay Botev <bono8106@hotmail.com> - [rulers] Clicking in line
 * number ruler should not trigger annotation ruler - https://bugs.eclipse.org/bugs/show_bug.cgi?id=40889
 *******************************************************************************/
...
public class LineNumberRulerColumn implements IVerticalRulerColumn
{
    ...
    class MouseHandler implements MouseListener, MouseMoveListener
    {
         ...
         * 
         * @param expandExistingSelection if <code>true</code> the existing selection will be expanded, otherwise a new
        ...
        {
            if (fCachedTextWidget != null && !fCachedTextWidget.isDisposed()) { return JFaceTextUtil
                    .getPartialTopIndex(fCachedTextViewer); }
            return -1;
        }
    }
     ...
     * @deprecated as of 3.2 the number of lines in the viewport cannot be computed because StyledText supports variable
     *             line heights
     */
