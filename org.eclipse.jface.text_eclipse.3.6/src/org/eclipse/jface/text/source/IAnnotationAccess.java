 ...
 * {@link org.eclipse.jface.text.source.Annotation}. With version 3.0 all this information is now available from the
 * annotation itself.
 * <p>
 * In order to provide backward compatibility for clients of <code>IAnnotationAccess</code>, extension interfaces are
 * used as a means of evolution. The following extension interfaces exist:
 * <ul>
 * <li>{@link org.eclipse.jface.text.source.IAnnotationAccessExtension} since version 3.0 replacing all methods in that
 * interface</li>
 * <li>{@link IAnnotationAccessExtension2} since version 3.2 allowing to set a quick assist assistant to an annotation
 * access.</li>
 * </ul>
 * </p>
 * <p>
...
public interface IAnnotationAccess
{
     ...
     * 
     * @param annotation the annotation
     * @return <code>true</code> if the annotation spans multiple lines, <code>false</code> otherwise
     ...
     * 
     * @param annotation the annotation
     * @return <code>true</code> if the annotation is temporary, <code>false</code> otherwise
