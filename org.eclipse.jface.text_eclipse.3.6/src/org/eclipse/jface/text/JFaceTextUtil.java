...
public final class JFaceTextUtil
{
     ...
     * available, otherwise by adapting the widget line to the viewer's {@link ITextViewer#getVisibleRegion() visible
     * region}.
     * 
     * @param viewer the viewer
     ...
     * available, otherwise by adapting the model line to the viewer's {@link ITextViewer#getVisibleRegion() visible
     * region}.
     * 
     * @param viewer the viewer
    ...
    /**
     * Translates a given region of the text viewer's document into the corresponding region of the viewer's widget.
     * 
    ...
    /**
     * Returns <code>true</code> if the text covered by <code>selection</code> does not contain any characters in the
     * given viewer. Note the difference to {@link ITextSelection#isEmpty()}, which returns <code>true</code> only for
     * invalid selections.
     * 
     * @param viewer the viewer
