...
/**
 * Standard implementation of {@link org.eclipse.jface.text.ITextDoubleClickStrategy}.
 * <p>
 * Selects words using <code>java.text.BreakIterator</code> for the default locale.
 * </p>
 * 
...
{
    /**
     * Implements a character iterator that works directly on instances of <code>IDocument</code>. Used to collaborate
     * with the break iterator.
     * 
     * @see IDocument
     * @since 2.0
     */
     ...
     * <p>
     * <strong>Note:</> This method must return <code>null</code> if it simply selects the word at the given offset.
     * </p>
     * 
