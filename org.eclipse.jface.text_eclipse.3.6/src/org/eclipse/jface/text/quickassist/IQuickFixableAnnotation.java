 ...
 * {@link org.eclipse.jface.text.quickassist.IQuickAssistAssistant#canFix(Annotation)} can be expensive.
 * </p>
 * <p>
...
public interface IQuickFixableAnnotation
{
     ...
     * <p>
     * Normally this means {@link #setQuickFixable(boolean)} has been called at least once but it can also be
     * hard-coded, e.g. always return <code>true</code>.
     * </p>
     * 
     ...
     * <p>
     * <strong>Note:</strong> This method must only be called if {@link #isQuickFixableStateSet()} returns
     * <code>true</code>.
     * </p>
     * 
