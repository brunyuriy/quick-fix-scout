 ...
 * <p>
 * As it is the responsibility of the implementer of {@link org.eclipse.jface.text.IInformationControl} and
 * {@link org.eclipse.jface.text.IInformationControlExtension2} to specify the concrete nature of the information
 * control's input, only the implementer can know whether it has something to show or not.
 * 
 * @since 2.0
 */
