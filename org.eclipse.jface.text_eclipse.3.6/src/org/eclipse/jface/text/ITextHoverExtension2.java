...
public interface ITextHoverExtension2
{
     ...
     * hover region has the same semantics as the region returned by {@link ITextHover#getHoverRegion(ITextViewer, int)}
     ...
     * returns {@link IInformationControl}s that implement {@link IInformationControlExtension2} and whose
     * {@link IInformationControlExtension2#setInput(Object)} can handle the information objects returned by this
     * method.
     * </p>
     * <p>
