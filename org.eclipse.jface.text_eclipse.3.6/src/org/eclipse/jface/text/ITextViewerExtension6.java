...
/**
 * Extension interface for {@link org.eclipse.jface.text.ITextViewer}. Introduces the concept of text hyperlinks and
 * adds access to the undo manager.
 * 
...
public interface ITextViewerExtension6
{
     ...
     * 
     * @param hyperlinkDetectors the new array of hyperlink detectors, <code>null</code> or an empty array to disable
     *            hyperlinking
