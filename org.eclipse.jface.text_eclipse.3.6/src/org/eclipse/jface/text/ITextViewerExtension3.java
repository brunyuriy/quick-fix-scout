 ...
 * <p>
 * This interface has been replaced by {@link org.eclipse.jface.text.ITextViewerExtension5}. Clients are not supposed to
 * use this interface any longer.
 * 
 * @since 2.1
...
{
    /**
     * Returns the minimal region of the viewer's document that completely comprises everything that is visible in the
     * viewer's widget or <code>null</code> if there is no such region.
     * 
    ...
    /**
     * Returns the widget line that corresponds to the given line of the viewer's document or <code>-1</code> if there
     * is no such line.
     * 
    ...
    /**
     * Returns the widget offset that corresponds to the given offset in the viewer's document or <code>-1</code> if
     ...
     * document or <code>null</code> if there is no such region.
     * 
    ...
    /**
     * Returns the offset of the viewer's document that corresponds to the given widget offset or <code>-1</code> if
     * there is no such offset
     * 
    ...
    /**
     * Returns the line of the viewer's document that corresponds to the given widget line or <code>-1</code> if there
     * is no such line.
     * 
