...
/**
 * Registered with a text viewer, view port listeners are informed about changes of a text viewer's view port. The view
 * port is that portion of the viewer's document which is visible in the viewer.
 * <p>
...
{
    /**
     * Informs that the view port changed. The given vertical position is the new vertical scrolling offset measured in
     * pixels.
     * <p>
