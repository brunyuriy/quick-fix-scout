...
/**
 * Extension interface for {@link org.eclipse.jface.text.contentassist.IContentAssistProcessor} which provides the
 * context for the {@linkplain org.eclipse.jface.contentassist.ISubjectControlContentAssistant subject control content
 * assistant}.
 * 
 * @since 3.0
...
public interface ISubjectControlContentAssistProcessor extends IContentAssistProcessor
{
     ...
     * 
     * @param contentAssistSubjectControl the content assist subject control whose document is used to compute the
     *            proposals
     ...
     * to the current cursor position within the content assist subject control.
     * 
     * @param contentAssistSubjectControl the content assist subject control whose document is used to compute the
     *            possible contexts
