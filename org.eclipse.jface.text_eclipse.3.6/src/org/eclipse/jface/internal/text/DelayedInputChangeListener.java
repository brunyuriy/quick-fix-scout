...
public final class DelayedInputChangeListener implements IInputChangedListener
{
     ...
     * @param informationControlReplacer the information control replacer, whose information control should get the new
     *            input
     */
    public DelayedInputChangeListener(IDelayedInputChangeProvider changeProvider,
