...
public class InformationControlReplacer extends AbstractInformationControlManager
{
    ...
    public void replaceInformationControl(IInformationControlCreator informationPresenterControlCreator,
            Rectangle contentBounds, Object information, final Rectangle subjectArea, boolean takeFocus)
    {
        try
        {
            fIsReplacing = true;
    ...
    public void showInformationControl(Rectangle subjectArea, Object information)
    {
        ...
        if (informationControl instanceof IInformationControlExtension3)
        {
            ...
            /*
             * Ensure minimal size. Interacting with a tiny information control (resizing, selecting text) would be a
             * pain.
             */
     ...
     * 
     * @return <code>true</code> while code from
     *         {@link #replaceInformationControl(IInformationControlCreator, Rectangle, Object, Rectangle, boolean)} is
     *         run
     */
