...
/**
 * A position updater that never deletes a position. If the region containing the position is deleted, the position is
 * moved to the beginning/end (falling together) of the change. If the region containing the position is replaced, the
 * position is placed at the same location inside the replacement text, but always inside the replacement text.
 * 
 * @since 3.1
 */
