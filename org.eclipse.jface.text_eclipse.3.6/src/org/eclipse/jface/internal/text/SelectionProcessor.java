/*******************************************************************************
 * Copyright (c) 2009 Avaloq Evolution AG and others. All rights reserved. This program and the accompanying materials
 * are made available under the terms of the Eclipse Public License v1.0 which accompanies this distribution, and is
 * available at http://www.eclipse.org/legal/epl-v10.html Contributors: Tom Eicher (Avaloq Evolution AG) - initial API
 * and implementation
 *******************************************************************************/
...
public final class SelectionProcessor
{
    ...
    {
        /**
         * Returns a text edit describing the text modification that would be executed if the given selection was
        ...
        /**
         * Returns <code>true</code> if the text covered by <code>selection</code> does not contain any characters. Note
         * the difference to {@link ITextSelection#isEmpty()}, which returns <code>true</code> only for invalid
         * selections.
         * 
         * @param selection the selection
         * @return <code>true</code> if <code>selection</code> does not contain any text, <code>false</code> otherwise
        ...
        /**
         * Returns <code>true</code> if <code>selection</code> covers text on two or more lines, <code>false</code>
         * otherwise.
         * 
         * @param selection the selection
         * @return <code>true</code> if <code>selection</code> covers text on two or more lines, <code>false</code>
         *         otherwise
        ...
        /**
         * Returns a selection similar to <code>selection</code> but {@linkplain #isEmpty(ISelection) empty}. Typically,
         * the selection is reduced to its left-most offset.
         * 
         * @param selection the selection
         * @param beginning <code>true</code> to collapse the selection to its smallest position (i.e. its left-most
         *            offset), <code>false</code> to collapse it to its greatest position (e.g its right-most offset)
    ...
    private final Implementation RANGE_IMPLEMENTATION = new Implementation()
    {
        ...
        {
            ITextSelection ts = (ITextSelection) selection;
            return fDocument.getLineOfOffset(ts.getOffset()) < fDocument.getLineOfOffset(ts.getOffset()
                    + ts.getLength());
        }
        ...
        {
            ITextSelection ts = (ITextSelection) selection;
            return beginning ? new TextSelection(fDocument, ts.getOffset(), 0) : new TextSelection(fDocument,
                    ts.getOffset() + ts.getLength(), 0);
        }
    ...
    private final Implementation COLUMN_IMPLEMENTATION = new Implementation()
    {
        ...
        TextEdit delete(ISelection selection) throws BadLocationException
        {
            ...
            {
                IBlockTextSelection cts = (IBlockTextSelection) selection;
                selection = new BlockTextSelection(fDocument, cts.getStartLine(), cts.getStartColumn(),
                        cts.getEndLine(), cts.getEndColumn() + 1, fTabWidth);
            }
            return replace(selection, ""); //$NON-NLS-1$
        }
        ...
        TextEdit backspace(ISelection selection) throws BadLocationException
        {
            ...
            {
                selection = new BlockTextSelection(fDocument, cts.getStartLine(), cts.getStartColumn() - 1,
                        cts.getEndLine(), cts.getEndColumn(), fTabWidth);
            }
            return replace(selection, ""); //$NON-NLS-1$
        }
        ...
        private TextEdit createReplaceEdit(int line, int visualStartColumn, int visualEndColumn, String replacement)
        ...
        private void appendColumnRange(StringBuffer buf, int line, int visualStartColumn, int visualEndColumn)
                throws BadLocationException
        {
            IRegion info = fDocument.getLineInformation(line);
            int lineLength = info.getLength();
        ...
        /**
         * Returns the increment in visual length represented by <code>character</code> given the current visual length.
         * The visual length is <code>1</code> unless <code>character</code> is a tabulator (<code>\t</code>).
         * 
    ...
    /**
     * Returns a text edit describing the text modification that would be executed if the delete key was pressed on the
     * given selection.
     * 
    ...
    /**
     * Returns a text edit describing the text modification that would be executed if the backspace key was pressed on
     * the given selection.
     * 
     * @param selection the selection to delete
     * @return a text edit describing the operation needed to delete <code>selection</code>
    ...
    /**
     * Returns a text edit describing the text modification that would be executed if the given selection was replaced
    ...
    /**
     * Returns <code>true</code> if the text covered by <code>selection</code> does not contain any characters. Note the
     * difference to {@link ITextSelection#isEmpty()}, which returns <code>true</code> only for invalid selections.
     * 
     * @param selection the selection
     * @return <code>true</code> if <code>selection</code> does not contain any text, <code>false</code> otherwise
     * @throws BadLocationException if accessing the document failed
    ...
    /**
     * Returns <code>true</code> if <code>selection</code> extends to two or more lines, <code>false</code> otherwise.
     * 
     * @param selection the selection
     * @return <code>true</code> if <code>selection</code> extends to two or more lines, <code>false</code> otherwise
     * @throws BadLocationException if <code>selection</code> is not valid regarding the target document
     */
    ...
    /**
     * Returns a selection similar to <code>selection</code> but {@linkplain #isEmpty(ISelection) empty}. Typically, the
     * selection is reduced to its extreme offsets.
     * 
     * @param selection the selection
     * @param beginning <code>true</code> to collapse the selection to its smallest position (i.e. its left-most
     *            offset), <code>false</code> to collapse it to its greatest position (e.g its right-most offset)
    ...
    /**
     * Convenience method that applies the edit returned from {@link #delete(ISelection)} to the underlying document.
     * 
     * @param selection the selection to delete
     * @throws BadLocationException if accessing the document failed
     */
    ...
    /**
     * Convenience method that applies the edit returned from {@link #replace(ISelection, String)} to the underlying
     * document and adapts the selection accordingly.
     * 
     * @param selection the selection to replace
     * @param replacement the replacement text
     * @throws BadLocationException if accessing the document failed
    ...
    /**
     * Returns the number of lines touched by <code>selection</code>. Note that for linear selections, this is the
     * number of contained delimiters plus 1.
     * 
     * @param selection the selection
     * @return the number of lines touched by <code>selection</code>
     * @throws BadLocationException if accessing the document failed
