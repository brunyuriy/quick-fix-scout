...
/**
 * A strategy for painting the quick diff colors onto the vertical ruler column. It also manages the quick diff hover.
 * 
 * @since 3.2
 */
public final class DiffPainter
{
     ...
     * @param sharedColors a shared colors object to store shaded colors in, may be <code>null</code>
     */
     ...
     * @param visibleModelLines the lines (in document offsets) that are currently (perhaps only partially) visible
     */
    ...
    /**
     * Retrieves the <code>ILineDiffInfo</code> for <code>line</code> from the model. There are optimizations for direct
     * access and sequential access patterns.
     * 
