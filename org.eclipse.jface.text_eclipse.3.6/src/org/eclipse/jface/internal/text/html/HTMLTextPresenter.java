        ...
        DefaultInformationControl.IInformationPresenterExtension
{
     ...
     * @deprecated Use {@link #updatePresentation(Drawable, String, TextPresentation, int, int)} instead
     */
    ...
    /*
     * @see IHoverInformationPresenterExtension#updatePresentation(Drawable drawable, String, TextPresentation, int,
     * int)
     * @since 3.2
     */
