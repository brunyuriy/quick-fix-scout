...
public abstract class BrowserInformationControlInput extends BrowserInput
{
    ...
    /**
     * Returns the HTML from {@link #getHtml()}. This is a fallback mode for platforms where the
     * {@link BrowserInformationControl} is not available and this input is passed to a
