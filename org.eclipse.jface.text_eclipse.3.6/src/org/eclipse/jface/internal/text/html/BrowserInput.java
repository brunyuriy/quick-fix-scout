...
/**
 * A browser input contains an input element and a previous and a next input, if available. The browser input also
 * provides a human readable name of its input element.
 * 
 * @since 3.4
 */
