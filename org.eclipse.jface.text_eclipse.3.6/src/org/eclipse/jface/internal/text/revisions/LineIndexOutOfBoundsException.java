...
/**
 * Thrown to indicate that an attempt to create or modify a {@link Range} failed because it would have resulted in an
 * illegal range. A range is illegal if its length is &lt;= 0 or if its start line is &lt; 0.
 * 
 * @since 3.2
 */
public final class LineIndexOutOfBoundsException extends IndexOutOfBoundsException
{
    ...
    /**
     * Constructs a new <code>LineIndexOutOfBoundsException</code> object with an argument indicating the illegal index.
     * 
