...
/**
 * A selection provider for annotate revisions. Selections of a revision can currently happen in following ways - note
 * that this list may be changed in the future:
 * <ul>
...
{
    /**
     * Post selection listener on the viewer that remembers the selection provider it is registered with.
     */
