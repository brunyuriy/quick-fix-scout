...
/**
 * A hunk describes a contiguous range of changed, added or deleted lines. <code>Hunk</code>s are separated by one or
...
{
    /**
     * The line at which the hunk starts in the current document. Must be in <code>[0, numberOfLines]</code> &ndash;
     * note the inclusive end; there may be a hunk with <code>line == numberOfLines</code> to describe deleted lines at
     * then end of the document.
     */
    public final int line;
    /**
     * The difference in lines compared to the corresponding line range in the original. Positive for added lines,
     * negative for deleted lines.
     */
