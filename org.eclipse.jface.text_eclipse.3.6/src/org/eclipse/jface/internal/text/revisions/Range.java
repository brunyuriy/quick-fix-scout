 ...
 * </ul>
 * <p>
 * Attempts to create or modify a <code>Range</code> such that this invariant would be violated result in a
 * {@link LineIndexOutOfBoundsException} being thrown.
 * </p>
 * 
 * @since 3.2
 */
public final class Range implements ILineRange, Cloneable
{
     ...
     * @throws LineIndexOutOfBoundsException if the passed {@link ILineRange} does not adhere to the contract of
     *             {@link Range}
     */
     ...
     * @throws LineIndexOutOfBoundsException if the parameters violate the invariant of {@link Range}
     */
    ...
    /**
     * Returns the first line after this range. Equivalent to {@linkplain #start() start} + {@linkplain #length()
     * length}.
     * 
    ...
    /**
     * Moves this range such that the {@link #end()} is at <code>end</code>, keeping {@link #length()} constant.
     * 
    ...
    /**
     * Moves the range by <code>delta</code> lines, keeping {@link #length()} constant. The resulting start line must be
     * &gt;= 0.
     * 
    ...
    /**
     * Splits a range off the end of the receiver. The receiver is shortened to only include <code>remaining</code>
     ...
     * @throws LineIndexOutOfBoundsException if <code>remaining</code>&gt;= {@link #length()} or <code>remaining</code>
     *             &ltt;= 0
     */
